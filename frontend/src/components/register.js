...
// Functional Component
  class Register extends Component {
    constructor(props) {
      super(props);
      this.state = {password: '',username: '',vpassword:'',email:''};
  
      this.handleChangepassword = this.handleChangepassword.bind(this);
      this.handleChangeusename = this.handleChangeusename.bind(this);
      this.handleChangeVpassword = this.handleChangeVpassword.bind(this);
    ...
    handleSubmit(event) {
      ...
      let url = `/api/register/?username=${this.state.username}&password=${this.state.password}&mail=${this.state.email}`;
      axios
      .get(url)
      .then((res) => {
        if(res.data.ok)
      ...
      >
        ...
        >
          ...
          <input
            ...
            value={this.state.vpassword} onChange={this.handleChangeVpassword} 
          />
        </div>
        ...
        <div className="flex justify-center items-center">
          <a className="text-[#9ACC13]" href="">i have acount</a>
        </div>
      </form>
    </div>
  );
